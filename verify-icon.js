...
if (process.platform === "win32") {
  ...
  exec(
    ...
    (error, stdout, stderr) => {
      ...
      console.log("   1. Right-click GetVideosLocally.exe → Properties");
      console.log('   2. Check the "Details" tab for version info');
      console.log(
        "   3. Check if icon appears in the top-left of Properties window",
      );
      console.log(
        "   4. Navigate to dist\\GetVideosLocally-win32-x64\\ and check icon in Explorer",
      );
